...
- Built queries to detect orders without payments and customers with unpaid orders.
- First solid practice with window functions using DENSE_RANK().
(minhyi notes: still need tons of help and not trully understanding this part.)
- Successfully wrote a query to retrieve the Top 3 customers by revenue in each city.
(minhyi notes: still need tons of help and not trully understanding this part.)
